 ...
 */
export async function validateAvatar(glbBuffer) {
    const alerts = [];
    const report = {};
    // 1. SHA-256 Hash
    ...
    // 5. Extension Sanity
    try {
        report.extensions = doc.getRoot().listExtensionsUsed().map(ext => ext.constructor.EXTENSION_NAME);
    }
    catch (e) {
        // ignore
    }
